...
<br><br>
![flask_basicMongoDockerToken](demo/demo.gif)
<br><br>
...
| Store Sentence | /store | POST | username:str,pasword:str,sentence:str | 200 ok, 302 incorrect password, 303 not enough tokens |
| Retrieve Sentence | /get | POST | username:str,pasword:str | 200 ok, 302 incorrect password, 303 not enough tokens |
